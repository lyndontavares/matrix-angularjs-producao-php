...
$app->get('/resultado', function() use($enqueteItemDAO) {
  $enqueteItemDAO->getGraficoResultado();
});
...
$app->get('/bydev', function() use($enqueteItemDAO,$app) {
  //echo 'oi';
  $request = $app->request();
  $body = $request->getBody();var_dump($body);
  $vo = json_decode($body);
