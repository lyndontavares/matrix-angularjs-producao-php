!function (t, e, n) {
    ...
    function r(t, e) {
        return e = e || Error, function () {
            ...
            for (n = o + a.replace(/\{\d+\}/g, function (t) {
                ...
                n = n + (2 == r ? "?" : "&") + "p" + (r - 2) + "=" + encodeURIComponent(he(arguments[r]));
            return new e(n)
        }
    }
    function i(t) {
        ...
        if (e) {
            ...
            if (hi(t)) {
                ...
                for (var s = 0; s < t.length; s++)
                    a = q(t[s], null, n, r), y(t[s]) && (n.push(t[s]), r.push(a)), e.push(a)
            } else {
                var u = e.$$hashKey;
                ...
                for (var c in t)
                    t.hasOwnProperty(c) && (a = q(t[c], null, n, r), y(t[c]) && (n.push(t[c]), r.push(a)), e[c] = a);
                l(e, u)
            }
        } else if (e = t, t)
            if (hi(t))
    ...
    function I(t, e) {
        ...
        if (a == s && "object" == a) {
            if (!hi(t)) {
                if (x(t))
                    return x(e) ? I(t.getTime(), e.getTime()) : !1;
                if (S(t))
                    return S(e) ? t.toString() == e.toString() : !1;
                if (k(t) || k(e) || E(t) || E(e) || hi(e) || x(e) || S(e))
                    return!1;
                o = {};
                for (i in t)
                    if ("$" !== i.charAt(0) && !C(t[i])) {
                ...
                for (i in e)
                    if (!o.hasOwnProperty(i) && "$" !== i.charAt(0) && e[i] !== n && !C(e[i]))
                        return!1;
                return!0
            }
            if (!hi(e))
    ...
    function re() {
        var e;
        gi || (ni = t.jQuery, ni && ni.fn.on ? (ei = ni, f(ni.fn, {scope: Ii.scope, isolateScope: Ii.isolateScope, controller: Ii.controller, injector: Ii.injector, inheritedData: Ii.inheritedData}), e = ni.cleanData, ni.cleanData = function (t) {
            var n;
            if (fi)
                fi = !1;
            else
    ...
    function de(e) {
        f(e, {bootstrap: Q, copy: q, extend: f, equals: I, element: ei, forEach: o, injector: Le, noop: p, bind: H, toJson: B, fromJson: L, identity: $, isUndefined: m, isDefined: g, isString: w, isFunction: C, isObject: y, isNumber: b, isElement: j, isArray: hi, version: Si, isDate: x, lowercase: Jr, uppercase: Zr, callbacks: {counter: 0}, getTestability: ee, $$minErr: r, $$csp: $i, reloadWithDebugInfo: te}), ri = le(t);
        try {
            ri("ngLocale")
        } catch (n) {
        ...
        ri("ng", ["ngLocale"], ["$provide", function (t) {
                t.provider({$$sanitizeUri: Jn}), t.provider("$compile", Ze).directive({a: Mo, input: Yo, textarea: Yo, form: qo, script: Ra, select: Fa, style: _a, option: Ha, ngBind: Zo, ngBindHtml: Qo, ngBindTemplate: Xo, ngClass: ea, ngClassEven: ra, ngClassOdd: na, ngCloak: ia, ngController: oa, ngForm: Ro, ngHide: Ma, ngIf: ua, ngInclude: ca, ngInit: fa, ngNonBindable: Ea, ngPluralize: ka, ngRepeat: Aa, ngShow: Da, ngStyle: ja, ngSwitch: Pa, ngSwitchWhen: Na, ngSwitchDefault: Va, ngOptions: Ua, ngTransclude: qa, ngModel: xa, ngList: ha, ngChange: ta, pattern: La, ngPattern: La, required: Ba, ngRequired: Ba, minlength: Ga, ngMinlength: Ga, maxlength: za, ngMaxlength: za, ngValue: Ko, ngModelOptions: Sa}).directive({ngInclude: la}).directive(jo).directive(aa), t.provider({$anchorScroll: ze, $animate: Yi, $browser: Ye, $cacheFactory: Je, $controller: en, $document: nn, $exceptionHandler: rn, $filter: sr, $interpolate: $n, $interval: vn, $http: fn, $httpBackend: dn, $location: Mn, $log: jn, $parse: Bn, $rootScope: Yn, $q: Ln, $$q: zn, $sce: Qn, $sceDelegate: Xn, $sniffer: tr, $templateCache: Ke, $templateRequest: er, $$testability: nr, $timeout: rr, $window: ar, $$rAF: Wn, $$asyncCallback: Ge, $$jqLite: Ue})
            }])
    }
    function pe() {
        return++ki
    ...
    function ge(t, e) {
        ...
        if (ve(t))
            ...
            for (n = n || s.appendChild(e.createElement("div")), r = (Vi.exec(t) || ["", ""])[1].toLowerCase(), i = Ri[r] || Ri._default, n.innerHTML = i[1] + t.replace(qi, "<$1></$2>") + i[2], a = i[0]; a--; )
                n = n.lastChild;
    ...
    function we(t) {
        ...
        if (w(t) && (t = di(t), e = !0), !(this instanceof we)) {
            if (e && "<" != t.charAt(0))
                throw ji("nosel", "Looking up elements via selectors is not supported by jqLite! See: http://docs.angularjs.org/api/angular.element");
            return new we(t)
        }
    ...
    function Ce(t, e, n, r) {
        if (g(r))
            throw ji("offargs", "jqLite#off() does not support the `selector` argument");
    ...
    function Ue() {
        this.$get = function () {
            return f(we, {hasClass: function (t, e) {
    ...
    function Be(t, e, n) {
        ...
        if ("function" == typeof t) {
            if (!(r = t.$inject)) {
                if (r = [], t.length) {
                    if (e)
                        throw w(n) && n || (n = t.name || _e(t)), Gi("strictdi", "{0} is not using explicit annotation and cannot be invoked in strict mode", n);
            ...
            hi(t) ? (s = t.length - 1, oe(t[s], "fn"), r = t.slice(0, s)) : oe(t, "fn", !0);
        return r
    }
    function Le(t, e) {
        function r(t) {
        ...
        function i(t, e) {
            if (ae(t, "service"), (C(e) || hi(e)) && (e = k.instantiate(e)), !e.$get)
                throw Gi("pget", "Provider '{0}' must define $get factory method.", t);
            return E[t + b] = e
        }
        function a(t, e) {
            return function () {
                ...
                if (m(n))
                    throw Gi("undef", "Provider '{0}' must return a value from $get factory method.", t);
                return n
            }
        }
        function s(t, e, n) {
        ...
        function $(t, n) {
            function r(e, r) {
                if (t.hasOwnProperty(e)) {
                    if (t[e] === g)
                        throw Gi("cdep", "Circular dependency found: {0}", e + " <- " + x.join(" <- "));
                    return t[e]
                }
                try {
            ...
            function i(t, n, i, o) {
                ...
                for (s = 0, a = l.length; a > s; s++) {
                    if (u = l[s], "string" != typeof u)
                        throw Gi("itkn", "Incorrect injection token! Expected service name as string, got {0}", u);
            ...
            return{invoke: i, instantiate: o, get: r, annotate: Le.$$annotate, has: function (e) {
                    return E.hasOwnProperty(e + b) || t.hasOwnProperty(e)
                }}
        }
        e = e === !0;
        var g = {}, b = "Provider", x = [], S = new He([], !0), E = {$provide: {provider: r(i), factory: r(s), service: r(c), value: r(l), constant: r(f), decorator: h}}, k = E.$injector = $(E, function (t, e) {
    ...
    function We(t, e, r, i) {
        ...
        $.cookies = function (t, e) {
            ...
            if (!t) {
                if (v.cookie !== R)
                    for (R = v.cookie, o = R.split("; "), q = {}, s = 0; s < o.length; s++)
                        a = o[s], u = a.indexOf("="), u > 0 && (t = d(a.substring(0, u)), q[t] === n && (q[t] = d(a.substring(u + 1))));
                return q
            }
    ...
    function Ze(t, r) {
        function i(t, e) {
            ...
            return o(t, function (t, i) {
                var o = t.match(n);
                if (!o)
                    throw Ji("iscp", "Invalid isolate scope definition for directive '{0}'. Definition: {... {1}: '{2}' ...}", e, i, t);
            ...
            return g(t) ? (x = t, this) : x
                ...
                function P(t, e, r, i, o, a) {
                    function s(t, r, i, o) {
                        ...
                        for (l = 0, f = $.length; f > l; )
                            u = v[$[l++]], a = $[l++], s = $[l++], a ? (a.scope ? (c = t.$new(), M.$$addScopeInfo(ei(u), c)) : c = t, d = a.transcludeOnThisElement ? q(t, a.transclude, o, a.elementTranscludeOnThisElement) : !a.templateOnThisElement && o ? o : !o && e ? q(t, e) : null, a(s, c, u, i, d)) : s && s(t, u.childNodes, n, o)
                    }
                    for (var u, c, l, f, h, d, p, $ = [], v = 0; v < t.length; v++)
                        u = new ae, c = R(t[v], [], u, 0 === v ? i : n, o), l = c.length ? _(c, t[v], u, e, r, null, [], [], a) : null, l && l.scope && M.$$addScopeClass(u.$$element), h = l && l.terminal || !(f = t[v].childNodes) || !f.length ? null : P(f, l ? (l.transcludeOnThisElement || !l.templateOnThisElement) && l.transclude : e), (l || h) && ($.push(v, l, h), d = !0, p = p || l), a = null;
                    return d ? s : null
                }
                function q(t, e, n) {
                    ...
                    switch (s) {
                        case yi:
                            ...
                            if (a = t.className, y(a) && (a = a.animVal), w(a) && "" !== a)
                                for (; o = l.exec(a); )
                                    d = Xe(o[2]), L(e, d, "C", r, i) && (n[d] = di(o[3])), a = a.substr(o.index + o[0].length);
                            break;
                        case wi:
                            Z(e, t.nodeValue);
                            break;
                ...
                function U(t, e, n) {
                    ...
                    if (e && t.hasAttribute && t.hasAttribute(e)) {
                        do {
                            if (!t)
                                throw Ji("uterdir", "Unterminated attribute, found '{0}' but no matching '{1}' found.", e, n);
                ...
                function _(t, a, s, u, c, l, f, h, d) {
                    ...
                    function $(t, e, n, r) {
                        ...
                        if (w(e)) {
                            if (a = e.match(m), e = e.substring(a[0].length), a[3] && (a[1] ? a[3] = null : a[1] = a[3]), "^" === a[1] ? s = "inheritedData" : "^^" === a[1] && (s = "inheritedData", c = n.parent()), "?" === a[2] && (u = !0), i = null, r && "data" === s && (i = r[e]) && (i = i.instance), i = i || c[s]("$" + e + "Controller"), !i && !u)
                                throw Ji("ctreq", "Controller '{0}', required by directive '{1}', can't be found!", e, t);
                            return i || null
                        }
                    ...
                    function b(t, e, i, u, c) {
                        ...
                        if (a === i ? (E = s, C = s.$$element) : (C = ei(i), E = new ae(C, s)), N && (w = e.$new(!0)), c && (x = l, x.$$boundTransclude = c), P && (S = {}, b = {}, o(P, function (t) {
                            var n, r = {$scope: t === N || t.$$isolateScope ? w : e, $element: C, $attrs: E, $transclude: x};
                        ...
                        for (S && (o(S, function (t) {
                            t()
                        }), S = null), d = 0, p = f.length; p > d; d++)
                            m = f[d], oe(m, m.isolateScope ? w : e, C, E, m.require && $(m.directiveName, m.require, C, b), x);
                        var O = e;
                        for (N && (N.template || null === N.templateUrl) && (O = w), t && t(O, i.childNodes, n, c), d = h.length - 1; d >= 0; d--)
                            m = h[d], oe(m, m.isolateScope ? w : e, C, E, m.require && $(m.directiveName, m.require, C, b), x)
                    }
                    d = d || {};
                    for (var x, S, E, A, T, O, D, j = -Number.MAX_VALUE, P = d.controllerDirectives, N = d.newIsolateScopeDirective, V = d.templateDirective, q = d.nonTlbTranscludeDirective, _ = !1, L = !1, G = d.hasElementTranscludeDirective, J = s.$$element = ei(a), Z = l, Q = u, te = 0, ne = t.length; ne > te; te++) {
                        ...
                        if ((D = E.scope) && (E.templateUrl || (y(D) ? (K("new/isolated scope", N || x, E, J), N = E) : K("new/isolated scope", N, E, J)), x = x || E), A = E.name, !E.templateUrl && E.controller && (D = E.controller, P = P || {}, K("'" + A + "' controller", P[A], E, J), P[A] = E), (D = E.transclude) && (_ = !0, E.$$tlb || (K("transclusion", q, E, J), q = E), "element" == D ? (G = !0, j = E.priority, T = J, J = s.$$element = ei(e.createComment(" " + A + ": " + s[A] + " ")), a = J[0], ee(c, F(T), a), Q = M(T, u, j, Z && Z.name, {nonTlbTranscludeDirective: q})) : (T = ei(be(a)).contents(), J.empty(), Q = M(T, u))), E.template)
                            if (L = !0, K("template", V, E, J), V = E, D = C(E.template) ? E.template(J, s) : E.template, D = le(D), E.replace) {
                                ...
                                J.html(D);
                        if (E.templateUrl)
                            L = !0, K("template", V, E, J), V = E, E.replace && (Z = E), b = Y(t.splice(te, t.length - te), J, s, c, _ && Q, f, h, {controllerDirectives: P, newIsolateScopeDirective: N, templateDirective: V, nonTlbTranscludeDirective: q}), ne = t.length;
                        else if (E.compile)
                            try {
                ...
                function L(e, r, o, u, c, l, f) {
                    ...
                    if (a.hasOwnProperty(r))
                        for (var p, $ = t.get(r + s), v = 0, m = $.length; m > v; v++)
                            try {
                                p = $[v], (u === n || u > p.priority) && -1 != p.restrict.indexOf(o) && (l && (p = d(p, {$$start: l, $$end: f})), e.push(p), h = p)
                            } catch (g) {
                                i(g)
                            }
                    return h
                ...
                function Y(t, e, n, r, i, a, s, c) {
                    var l, f, h = [], p = e[0], $ = t.shift(), v = d($, {templateUrl: null, transclude: null, replace: null, $$originalDirective: $}), m = C($.templateUrl) ? $.templateUrl(e, n) : $.templateUrl, g = $.templateNamespace;
                    return e.empty(), u(A.getTrustedResourceUrl(m)).then(function (u) {
                        var d, w, b, x;
                        if (u = le(u), $.replace) {
                            if (b = ve(u) ? [] : tn(X(g, di(u))), d = b[0], 1 != b.length || d.nodeType !== yi)
                                throw Ji("tplrt", "Template for directive '{0}' must have exactly one root element. {1}", $.name, m);
                            w = {$attr: {}}, ee(r, e, d);
                            var C = R(d, [], w);
                ...
                function K(t, e, n, r) {
                    if (e)
                        throw Ji("multidir", "Multiple directives [{0}, {1}] asking for {2} on: {3}", e.name, n.name, t, z(r))
                }
                function Z(t, e) {
                    var n = r(e, !0);
                ...
                function te(t, e, n, i, o) {
                    ...
                    var s = r(n, !0, a, o);
                    if (s) {
                        if ("multiple" === i && "select" === N(t))
                            throw Ji("selmulti", "Binding to the 'multiple' attribute is not supported. Element: {0}", z(t));
                        e.push({priority: 100, compile: function () {
                                return{pre: function (t, e, u) {
                                        var c = u.$$observers || (u.$$observers = {});
                                        if (b.test(i))
                                            throw Ji("nodomevents", "Interpolations for HTML DOM event attributes are disallowed.  Please use the ng- versions (such as ng-click instead of onclick) instead.");
                                        var l = u[i];
                ...
                ae.prototype = {$normalize: Xe, $addClass: function (t) {
                        ...
                        if (c ? (this.$$element.prop(t, e), a = c) : l && (this[l] = e, f = l), this[t] = e, a ? this.$attr[t] = a : (a = this.$attr[t], a || (this.$attr[t] = a = ne(t, "-"))), s = N(this.$$element), "a" === s && "href" === t || "img" === s && "src" === t)
                            this[t] = e = O(e, "src" === t);
            ...
            e = !0
                ...
                return function (r, u, c, l) {
                    ...
                    if (c = c === !0, l && w(l) && ($ = l), w(r)) {
                        if (d = r.match(i), !d)
                            throw Zi("ctrlfmt", "Badly formed controller string '{0}'. Must match `__name__ as __id__` or `__name__`.", r);
    ...
    function fn() {
        var t = this.defaults = {transformResponse: [on], transformRequest: [function (t) {
                ...
                }], headers: {common: {Accept: "application/json, text/plain, */*"}, post: R(Qi), put: R(Qi), patch: R(Qi)}, xsrfCookieName: "XSRF-TOKEN", xsrfHeaderName: "X-XSRF-TOKEN"}, e = !1;
        ...
        this.$get = ["$httpBackend", "$browser", "$cacheFactory", "$rootScope", "$q", "$injector", function (a, u, c, l, h, d) {
                ...
                function b(r, i) {
                    ...
                    function s(t, e, n, i) {
                        e = Math.max(e, 0), (ln(e) ? v.resolve : v.reject)({data: t, status: e, headers: un(n), config: r, statusText: i})
                    }
                    function c(t) {
    ...
    function pn(t, e, r, i, a) {
        ...
        return function (a, u, c, l, f, h, d, $) {
            ...
            if (t.$$incOutstandingRequestCount(), u = u || t.url(), "jsonp" == Jr(a)) {
                ...
                if (b.onerror = x, b.onabort = x, d && (b.withCredentials = !0), $)
                    try {
                        b.responseType = $
                    } catch (C) {
                        if ("json" !== $)
    ...
    function Hn(t, e, r) {
        ...
        if (e.csp)
            s = 6 > c ? Un(u[0], u[1], u[2], u[3], u[4], r, i) : function (t, e) {
                var o, a = 0;
                do
                    o = Un(u[a++], u[a++], u[a++], u[a++], u[a++], r, i)(t, e), e = n, t = o;
                while (c > a);
                return o
            };
        else {
    ...
    function Bn() {
        ...
        this.$get = ["$filter", "$sniffer", function (n, r) {
                ...
                function u(t, e, n, r) {
                    ...
                    for (var c = [], l = 0, f = o.length; f > l; l++)
                        c[l] = s;
    ...
    function Yn() {
        ...
        this.digestTtl = function (t) {
            return arguments.length && (e = t), e
                ...
                d.prototype = {constructor: d, $new: function (e, n) {
                        var r;
                            ...
                            if (!m(o)) {
                                if (y(o))
                                    if (i(o)) {
                                        ...
                                        a !== p && (a = p = {}, v = 0, f++), e = 0;
                                        for (n in o)
                                            o.hasOwnProperty(n) && (e++, s = o[n], u = a[n], n in a ? (r = u !== u && s !== s, r || u === s || (f++, a[n] = s)) : (v++, a[n] = s, f++));
                                        if (v > e) {
                                            f++;
                                            for (n in a)
                                                o.hasOwnProperty(n) || (v--, delete a[n])
                                        }
                                    }
                                else
                                    a !== o && (a = o, f++);
                                        ...
                                        try {
                                            if (t = o[c])
                                                if ((r = t.get(d)) === (i = t.last) || (t.eq ? I(r, i) : "number" == typeof r && "number" == typeof i && isNaN(r) && isNaN(i))) {
                                                    ...
                                                    l = !0, a = t, t.last = t.eq ? q(r, null) : r, t.fn(r, i === w ? r : i, d), 5 > g && (p = 4 - g, x[p] || (x[p] = []), x[p].push({msg: C(t.exp) ? "fn: " + (t.exp.name || t.exp.toString()) : t.exp, newVal: r, oldVal: i}))
                                        } catch (A) {
                                            u(A)
                                        }
                                if (!(h = d.$$childHead || d !== y && d.$$nextSibling))
                                    for (; d !== y && !(h = d.$$nextSibling); )
                                        d = d.$parent
                            } while (d = h);
                            if ((l || E.length) && !g--)
                        ...
                        var e, n, r, i = [], o = this, a = !1, s = {name: t, targetScope: o, stopPropagation: function () {
                            ...
                            }, defaultPrevented: !1}, c = U([s], arguments, 1);
                        do {
    ...
    function Kn(t) {
        ...
        if (w(t)) {
            if (t.indexOf("***") > -1)
                throw bo("iwcard", "Illegal sequence *** in string matcher.  String: {0}", t);
        ...
        this.resourceUrlWhitelist = function (e) {
            ...
            return arguments.length && (e = Zn(t)), e
                ...
                function s(t, e) {
                    ...
                    if (!r)
                        throw bo("icontext", "Attempted to trust a value in invalid context. Context: {0}; Value: {1}", t, e);
                    if (null === e || e === n || "" === e)
                        return e;
                    if ("string" != typeof e)
                        throw bo("itype", "Attempted to trust a non-string value in a content requiring a string: Context: {0}", t);
                    return new r(e)
                }
                function u(t) {
                ...
                var f = a(), h = {};
                return h[xo.HTML] = a(f), h[xo.CSS] = a(f), h[xo.URL] = a(f), h[xo.JS] = a(f), h[xo.RESOURCE_URL] = a(h[xo.URL]), {trustAs: s, getTrusted: c, valueOf: u}
            }]
    }
    function Qn() {
        var t = !0;
        this.enabled = function (e) {
            return arguments.length && (t = !!e), t
                ...
                if (t && 8 > ti)
                    throw bo("iequirks", "Strict Contextual Escaping does not support Internet Explorer version < 11 in quirks mode.  You can fix this by adding the text <!doctype html> to the top of your HTML document.  See http://docs.angularjs.org/api/ng.$sce for more information.");
                var r = R(xo);
    ...
    function er() {
        this.$get = ["$templateCache", "$http", "$q", function (t, e, n) {
                function r(i, o) {
                    function a(t) {
                        if (!o)
                            throw Ji("tpload", "Failed to load template: {0}", i);
                        return n.reject(t)
                    }
    ...
    function ir(t) {
        var e = t;
        return ti && (Co.setAttribute("href", e), e = Co.href), Co.setAttribute("href", e), {href: Co.href, protocol: Co.protocol ? Co.protocol.replace(/:$/, "") : "", host: Co.host, search: Co.search ? Co.search.replace(/^\?/, "") : "", hash: Co.hash ? Co.hash.replace(/^#/, "") : "", hostname: Co.hostname, port: Co.port, pathname: "/" === Co.pathname.charAt(0) ? Co.pathname : "/" + Co.pathname}
    }
    function or(t) {
        var e = w(t) ? ir(t) : t;
    ...
    function dr(t, e, n, r, i) {
        ...
        if (c)
            ...
            if (d.length >= v + g)
                for ($ = d.length - v, p = 0; $ > p; p++)
                    ($ - p) % g === 0 && 0 !== p && (s += n), s += d.charAt(p);
            for (p = $; p < d.length; p++)
                (d.length - p) % v === 0 && 0 !== p && (s += n), s += d.charAt(p);
            for (; h.length < i; )
                h += "0";
    ...
    function Sr(t) {
        ...
        return function (n, r, i) {
            var a, s, u = "", c = [];
            if (r = r || "mediumDate", r = t.DATETIME_FORMATS[r] || r, w(n) && (n = To.test(n) ? h(n) : e(n)), b(n) && (n = new Date(n)), !x(n))
                return n;
            for (; r; )
                s = Ao.exec(r), s ? (c = U(c, s, 1), r = c.pop()) : (c.push(r), r = null);
    ...
    function Dr(t, e, r, i, a) {
        ...
        }, zr({ctrl: this, $element: t, set: function (t, e, n) {
                var r = t[e];
                if (r) {
                    var i = r.indexOf(n);
                    -1 === i && r.push(n)
    ...
    function qr(t, e, r, i) {
        return function (o, a, s, u, c, l, f) {
            ...
            if (u.$$parserName = t, u.$parsers.push(function (t) {
                ...
                if (t && !x(t))
                    throw wa("datefmt", "Expected `{0}` to be a date", t);
                if (h(t)) {
                    if (p = t, p && "UTC" === $) {
    ...
    function Ir(t, e, r, i, o, a) {
        if (Rr(t, e, r, i), Pr(t, e, r, i, o, a), i.$$parserName = "number", i.$parsers.push(function (t) {
            ...
            if (!i.$isEmpty(t)) {
                if (!b(t))
                    throw wa("numfmt", "Expected `{0}` to be a number", t);
                t = t.toString()
            }
            return t
        }), g(r.min) || r.ngMin) {
    ...
    }, vi = ["ng-", "data-ng-", "ng:", "x-ng-"], mi = /[A-Z]/g, gi = !1, yi = 1, wi = 3, bi = 8, xi = 9, Ci = 11, Si = {full: "1.3.15", major: 1, minor: 3, dot: 15, codeName: "locality-filtration"};
    we.expando = "ng339";
    ...
    var Oi = /([\:\-\_]+(.))/g, Di = /^moz([A-Z])/, Mi = {mouseleave: "mouseout", mouseenter: "mouseover"}, ji = r("jqLite"), Pi = /^<(\w+)\s*\/?>(?:<\/\1>|)$/, Ni = /<|&#?\w+;/, Vi = /<([\w:]+)/, qi = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, Ri = {option: [1, '<select multiple="multiple">', "</select>"], thead: [1, "<table>", "</table>"], col: [2, "<table><colgroup>", "</colgroup></table>"], tr: [2, "<table><tbody>", "</tbody></table>"], td: [3, "<table><tbody><tr>", "</tr></tbody></table>"], _default: [0, "", ""]};
    Ri.optgroup = Ri.option, Ri.tbody = Ri.tfoot = Ri.colgroup = Ri.caption = Ri.thead, Ri.th = Ri.td;
    var Ii = we.prototype = {ready: function (n) {
            function r() {
                i || (i = !0, n())
            }
            var i = !1;
        ...
        }, length: 0, push: ai, sort: [].sort, splice: [].splice}, Ui = {};
    ...
    o({data: ke, removeData: Se}, function (t, e) {
        ...
        we.prototype[e] = function (e, r) {
    ...
    }), o({removeData: Se, on: function Wa(t, e, n, r) {
            if (g(r))
                throw ji("onargs", "jqLite#on() does not support the `selector` or `eventData` parameters");
            if (me(t)) {
            ...
            l && (r = {preventDefault: function () {
                ...
                }, stopPropagation: p, type: s, target: t}, e.type && (r = f(r, e)), i = R(l), a = n ? [r].concat(n) : [r], o(i, function (e) {
                r.isImmediatePropagationStopped() || e.apply(t, a)
            }))
        }}, function (t, e) {
        we.prototype[e] = function (e, n, r) {
            for (var i, o = 0, a = this.length; a > o; o++)
                m(i) ? (i = t(this[o], e, n, r), g(i) && (i = ei(i))) : De(i, t(this[o], e, n, r));
            return g(i) ? i : this
    ...
    var Wi = r("$animate"), Yi = ["$provide", function (t) {
            this.$$selectors = {}, this.register = function (e, n) {
                var r = e + "-animation";
                if (e && "." != e.charAt(0))
                    throw Wi("notcsel", "Expecting class selector starting with '.' got '{0}'.", e);
                ...
                return 1 === arguments.length && (this.$$classNameFilter = t instanceof RegExp ? t : null), this.$$classNameFilter
                    ...
                    return{animate: function (t, e, n) {
                            ...
                            t = ei(t);
                            var l = t.data(u);
                            l ? o && l.options && (l.options = ci.extend(l.options || {}, o)) : (l = {classes: {}, options: o}, c = !0);
                            var f = l.classes;
    ...
    var Ki = /^((?:x|data)[\:\-_])/i, Zi = r("$controller"), Xi = "application/json", Qi = {"Content-Type": Xi + ";charset=utf-8"}, to = /^\[|^\{(?!\{)/, eo = {"[": /]$/, "{": /}$/}, no = /^\)\]\}',?\n/, ro = r("$interpolate"), io = /^([^\?#]*)(\?([^#]*))?(#(.*))?$/, oo = {http: 80, https: 443, ftp: 21}, ao = r("$location"), so = {$$html5: !1, $$replace: !1, absUrl: On("$$absUrl"), url: function (t) {
            if (m(t))
                return this.$$url;
            var e = io.exec(t);
    ...
    vo.prototype = {constructor: vo, lex: function (t) {
    ...
    mo.ZERO = f(function () {
        return 0
    }, {sharedGetter: !0, constant: !0}), mo.prototype = {constructor: mo, parse: function (t) {
    ...
    var go = ce(), yo = ce(), wo = Object.prototype.valueOf, bo = r("$sce"), xo = {HTML: "html", CSS: "css", URL: "url", RESOURCE_URL: "resourceUrl", JS: "js"}, Ji = r("$compile"), Co = e.createElement("a"), So = ir(t.location.href);
    sr.$inject = ["$provide"], fr.$inject = ["$locale"], hr.$inject = ["$locale"];
    var Eo = ".", ko = {yyyy: $r("FullYear", 4), yy: $r("FullYear", 2, 0, !0), y: $r("FullYear", 1), MMMM: vr("Month"), MMM: vr("Month", !0), MM: $r("Month", 2, 1), M: $r("Month", 1, 1), dd: $r("Date", 2), d: $r("Date", 1), HH: $r("Hours", 2), H: $r("Hours", 1), hh: $r("Hours", 2, -12), h: $r("Hours", 1, -12), mm: $r("Minutes", 2), m: $r("Minutes", 1), ss: $r("Seconds", 2), s: $r("Seconds", 1), sss: $r("Milliseconds", 3), EEEE: vr("Day"), EEE: vr("Day", !0), a: br, Z: mr, ww: wr(2), w: wr(1), G: xr, GG: xr, GGG: xr, GGGG: Cr}, Ao = /((?:[^yMdHhmsaZEwG']+)|(?:'(?:[^']|'')*')|(?:E+|y+|M+|d+|H+|h+|m+|s+|a|Z|G+|w+))(.*)/, To = /^\-?\d+$/;
    Sr.$inject = ["$locale"];
    var Oo = v(Jr), Do = v(Zr);
    Ar.$inject = ["$parse"];
    var Mo = v({restrict: "E", compile: function (t, e) {
    ...
    var Po = {$addControl: p, $$renameControl: Or, $removeControl: p, $setValidity: p, $setDirty: p, $setPristine: p, $setSubmitted: p}, No = "ng-submitted";
    Dr.$inject = ["$element", "$attrs", "$scope", "$animate", "$interpolate"];
    var Vo = function (t) {
        return["$timeout", function (e) {
                var r = {name: "form", restrict: t ? "EAC" : "E", controller: Dr, compile: function (r, i) {
    ...
    }, qo = Vo(), Ro = Vo(!0), Io = /\d{4}-[01]\d-[0-3]\dT[0-2]\d:[0-5]\d:[0-5]\d\.\d+([+-][0-2]\d:[0-5]\d|Z)/, Uo = /^(ftp|http|https):\/\/(\w+:{0,1}\w*@)?(\S+)(:[0-9]+)?(\/|\/([\w#!:.?+=&%@!\-\/]))?$/, Fo = /^[a-z0-9!#$%&'*+\/=?^_`{|}~.-]+@[a-z0-9]([a-z0-9-]*[a-z0-9])?(\.[a-z0-9]([a-z0-9-]*[a-z0-9])?)*$/i, Ho = /^\s*(\-|\+)?(\d+|(\d*(\.\d*)))\s*$/, _o = /^(\d{4})-(\d{2})-(\d{2})$/, Bo = /^(\d{4})-(\d\d)-(\d\d)T(\d\d):(\d\d)(?::(\d\d)(\.\d{1,3})?)?$/, Lo = /^(\d{4})-W(\d\d)$/, zo = /^(\d{4})-(\d\d)$/, Go = /^(\d\d):(\d\d)(?::(\d\d)(\.\d{1,3})?)?$/, Wo = {text: jr, date: qr("date", _o, Vr(_o, ["yyyy", "MM", "dd"]), "yyyy-MM-dd"), "datetime-local": qr("datetimelocal", Bo, Vr(Bo, ["yyyy", "MM", "dd", "HH", "mm", "ss", "sss"]), "yyyy-MM-ddTHH:mm:ss.sss"), time: qr("time", Go, Vr(Go, ["HH", "mm", "ss", "sss"]), "HH:mm:ss.sss"), week: qr("week", Lo, Nr, "yyyy-Www"), month: qr("month", zo, Vr(zo, ["yyyy", "MM"]), "yyyy-MM"), number: Ir, url: Ur, email: Fr, radio: Hr, checkbox: Br, hidden: p, button: p, submit: p, reset: p, file: p}, Yo = ["$browser", "$sniffer", "$filter", "$parse", function (t, e, n, r) {
        ...
        }], ta = v({restrict: "A", require: "ngModel", link: function (t, e, n, r) {
            r.$viewChangeListeners.push(function () {
                t.$eval(n.ngChange)
            })
        }}), ea = Lr("", !0), na = Lr("Odd", 0), ra = Lr("Even", 1), ia = Tr({compile: function (t, e) {
    ...
    var ua = ["$animate", function (t) {
            ...
            return{restrict: "ECA", priority: 400, terminal: !0, transclude: "element", controller: ci.noop, compile: function (i, o) {
        ...
        }], fa = Tr({priority: 450, compile: function () {
        ...
        return{restrict: "A", priority: 100, require: "ngModel", link: function (t, e, r, i) {
            ...
            this.$$setOptions = function (t) {
                if (x.$options = t, t && t.getterSetter) {
                    ...
                    throw wa("nonassign", "Expression '{0}' is non-assignable. Element: {1}", r.ngModel, z(i))
            }, this.$render = p, this.$isEmpty = function (t) {
                return m(t) || "" === t || null === t || t !== t
            };
            var S = i.inheritedData("$formController") || Po, E = 0;
            zr({ctrl: this, $element: i, set: function (t, e) {
                    t[e] = !0
                }, unset: function (t, e) {
                    delete t[e]
                }, parentForm: S, $animate: s}), this.$setPristine = function () {
                ...
                function s() {
                    ...
                    o(x.$asyncValidators, function (o, a) {
                        var s = o(t, e);
                        if (!M(s))
                            throw wa("$asyncValidators", "Expected asynchronous validator to return a promise but got '{0}' instead.", s);
            ...
            return{restrict: "A", require: ["ngModel", "^?form", "^?ngModelOptions"], controller: ba, priority: 1, compile: function (e) {
                    return e.addClass($a).addClass(ma).addClass(da), {pre: function (t, e, n, r) {
                            var i = r[0], o = r[1] || Po;
                    ...
                    return y ? x = t(y) : (S = function (t, e) {
                        ...
                        t.$watchCollection(m, function (r) {
                            ...
                            if (g && (t[g] = r), i(r))
                                ...
                                O = C || E, D = [];
                                for (var q in r)
                                    r.hasOwnProperty(q) && "$" != q.charAt(0) && D.push(q);
                                D.sort()
                            }
                            for (x = D.length, j = new Array(x), h = 0; x > h; h++)
                                if (k = r === D ? h : D[h], A = r[k], T = O(k, A, h), v[T])
                                    M = v[T], delete v[T], V[T] = M, j[h] = M;
                                else {
                                    if (V[T])
        ...
        }], Na = Tr({transclude: "element", priority: 1200, require: "^ngSwitch", multiElement: !0, link: function (t, e, n, r, i) {
            r.cases["!" + n.ngSwitchWhen] = r.cases["!" + n.ngSwitchWhen] || [], r.cases["!" + n.ngSwitchWhen].push({transclude: i, element: e})
        }}), Va = Tr({transclude: "element", priority: 1200, require: "^ngSwitch", multiElement: !0, link: function (t, e, n, r, i) {
            r.cases["?"] = r.cases["?"] || [], r.cases["?"].push({transclude: i, element: e})
        }}), qa = Tr({restrict: "EAC", link: function (t, e, n, i, o) {
            if (!o)
                    ...
                    function d(e, s, u) {
                        ...
                        function h() {
                            ...
                            if (n) {
                                t = {};
                                for (var o in n)
                                    n.hasOwnProperty(o) && (t[o] = c(k, o, n[o]))
                            }
                            return t
                        }
                        function d(t) {
                        ...
                        function m() {
                            ...
                            for (q = {}, A = 0; w = L.length, w > A; A++)
                                h = A, D && (h = L[A], "$" === h.charAt(0)) || (p = B[h], t = c(M, h, p) || "", (n = F[t]) || (n = F[t] = [], H.push(t)), T = G(h, p), W = W || T, N = c(k, h, p), N = g(N) ? N : "", U = V ? V(e, I) : D ? L[A] : A, V && (q[U] = h), n.push({id: U, label: N, selected: T}));
                            for (y || (b || null === _ ? F[""].unshift({id: "", label: "", selected: !W}) : W || F[""].unshift({id: "?", label: "", selected: !0})), E = 0, m = H.length; m > E; E++) {
                                for (t = H[E], n = F[t], R.length <= E?(i = {element:S.clone().attr("label", t), label:n.label}, l = [i], R.push(l), s.append(i.element)):(l = R[E], i = l[0], i.label != t && i.element.attr("label", i.label = t)), O = null, A = 0, w = n.length; w > A; A++)
                                    r = n[A], (f = l[A + 1]) ? (O = f.element, f.label !== r.label && (v(z, f.label, !1), v(z, r.label, !0), O.text(f.label = r.label), O.prop("label", f.label)), f.id !== r.id && O.val(f.id = r.id), O[0].selected !== r.selected && (O.prop("selected", f.selected = r.selected), ti && O.prop("selected", f.selected))) : ("" === r.id && b ? j = b : (j = C.clone()).val(r.id).prop("selected", r.selected).attr("selected", r.selected).prop("label", r.label).text(r.label), l.push(f = {element: j, label: r.label, id: r.id, selected: r.selected}), v(z, r.label, !0), O ? O.after(j) : i.element.append(j), O = j);
                                for (A++; l.length > A; )
                                    r = l.pop(), v(z, r.label, !1), r.element.remove()
                            }
                            for (; R.length > E; ) {
                                for (n = R.pop(), A = 1; A < n.length; ++A)
                                    v(z, n[A].label, !1);
                                n[0].element.remove()
                            }
                            o(z, function (t, e) {
                        ...
                        var E;
                        if (!(E = w.match(i)))
                            throw Ia("iexp", "Expected expression in form of '_select_ (as _label_)? for (_key_,)?_value_ in _collection_' but got '{0}'. Element: {1}", w, z(s));
                        var k = r(E[2] || E[1]), A = E[4] || E[6], T = / as /.test(E[0]) && E[1], O = T ? r(T) : null, D = E[5], M = r(E[3] || ""), j = r(E[2] ? E[1] : A), P = r(E[7]), N = E[8], V = N ? r(E[8]) : null, q = {}, R = [[{element: s, label: ""}]], I = {};
        ...
        return{restrict: "A", require: "?ngModel", link: function (t, e, i, o) {
                if (o) {
                    ...
                    i.$observe("pattern", function (t) {
                        if (w(t) && t.length > 0 && (t = new RegExp("^" + t + "$")), t && !t.test)
    ...
    function a(t, r, i, o) {
        ...
        function c(t, a, s, c, l, v, m) {
            ...
            if (b && b.match(t, a)) {
                ...
                if (h.shift(), b.response)
                    return void d.push(y(b));
                x = !0
            }
            for (var C, S = -1; C = f[++S]; )
                if (C.match(t, a, s, l || {})) {
        ...
        return c.when = function (t, e, r, i) {
            var u = new s(t, e, r, i), c = {respond: function (t, e, r, i) {
            ...
            var i = new s(t, e, n, r), o = {respond: function (t, e, n, r) {
                    return i.response = a(t, e, n, r), o
                }};
            return h.push(i), o
        }, l("expect"), c.flush = function (n, r) {
            if (r !== !1 && t.$digest(), !d.length)
    ...
    e.mock = {}, e.mock.$BrowserProvider = function () {
        ...
        this.isMock = !0, t.$$url = "http://server/", t.$$lastUrl = t.$$url, t.pollFns = [], t.$$completeOutstandingRequest = e.noop, t.$$incOutstandingRequestCount = e.noop, t.onUrlChange = function (e) {
            ...
            return n = n || 0, t.deferredFns.push({time: t.defer.now + n, fn: e, id: t.deferredNextId}), t.deferredFns.sort(function (t, e) {
            ...
            if (e.isDefined(n))
                ...
                if (!t.deferredFns.length)
                    throw new Error("No deferred tasks to be flushed");
                t.defer.now = t.deferredFns[t.deferredFns.length - 1].time
            }
            for (; t.deferredFns.length && t.deferredFns[0].time <= t.defer.now; )
                t.deferredFns.shift().fn()
        }, t.$$baseHref = "/", t.baseHref = function () {
            return this.$$baseHref
        }
    }, e.mock.$Browser.prototype = {poll: function () {
        ...
        this.mode = function (e) {
            switch (e) {
                ...
                case"rethrow":
                    var n = [];
                    t = function (t) {
                        if (n.push(1 == arguments.length ? t : [].slice.call(arguments, 0)), "rethrow" === e)
                            throw t
                    }, t.errors = n;
                    break;
                default:
        ...
        this.debugEnabled = function (t) {
            ...
            return r.reset = function () {
                ...
                if (e.forEach(["error", "warn", "info", "log", "debug"], function (n) {
                    ...
                    throw t.unshift("Expected $log to be empty! Either a message was logged unexpectedly, or an expected log message was not checked and removed:"), t.push(""), new Error(t.join("\n---------\n"))
            }, r.reset(), r
        }
        ...
        this.$get = ["$browser", "$rootScope", "$q", "$$q", function (t, r, i, o) {
                var a = [], s = 0, u = 0, c = function (c, l, f, h) {
                    ...
                    return f = e.isDefined(f) ? f : 0, m.then(null, null, c), m.$$intervalId = s, a.push({nextTime: u + l, delay: l, fn: d, id: s, deferred: v}), a.sort(function (t, e) {
    ...
    if (e.mock.TzDate = function (t, n) {
        ...
        if (e.isString(n)) {
            var a = n;
            if (i.origDate = r(n), n = i.origDate.getTime(), isNaN(n))
                throw{name: "Illegal Argument", message: "Arg '" + a + "' passed into TzDate constructor is not a valid date string"}
        } else
        ...
        return e.forEach(u, function (t) {
            ...
            t.value("$$animateReflow", function (t) {
                ...
                return n.push(t), function () {
                    ...
                    var o = {queue: [], cancel: t.cancel, enabled: t.enabled, triggerCallbackEvents: function () {
                            r.flush()
                    ...
                    return e.forEach(["animate", "enter", "leave", "move", "addClass", "removeClass", "setClass"], function (e) {
                        o[e] = function () {
                            return o.queue.push({event: e, element: arguments[0], options: arguments[arguments.length - 1], args: arguments}), t[e].apply(t, arguments)
                        }
                    }), o
                }])
        ...
        function r(t, n) {
            ...
            var i = [n + "Scope(" + t.$id + "): {"];
            for (var o in t)
                Object.prototype.hasOwnProperty.call(t, o) && !o.match(/^(\$|this)/) && i.push("  " + o + ": " + e.toJson(t[o]));
            for (var a = t.$$childHead; a; )
                i.push(r(a, n + "  ")), a = a.$$nextSibling;
        ...
        this.$get = function () {
        ...
        }], e.module("ngMock", ["ng"]).provider({$browser: e.mock.$BrowserProvider, $exceptionHandler: e.mock.$ExceptionHandlerProvider, $log: e.mock.$LogProvider, $interval: e.mock.$IntervalProvider, $httpBackend: e.mock.$HttpBackendProvider, $rootElement: e.mock.$RootElementProvider}).config(["$provide", function (t) {
            ...
            function e() {
                for (var t, e = 0, n = [this.$$childHead]; n.length; )
                    for (t = n.shift(); t; )
                        e += 1, n.push(t.$$childHead), t = t.$$nextSibling;
                return e
            }
            function n() {
                for (var t, e = this.$$watchers ? this.$$watchers.length : 0, n = [this.$$childHead]; n.length; )
                    for (t = n.shift(); t; )
                        e += t.$$watchers ? t.$$watchers.length : 0, n.push(t.$$childHead), t = t.$$nextSibling;
                return e
            }
            ...
            r.decorator("$animate", ["$delegate", "$$q", "$injector", "$sniffer", "$rootElement", "$$asyncCallback", "$rootScope", "$document", "$templateRequest", "$$jqLite", function (t, n, r, v, b, x, C, S, E, k) {
                    ...
                    function j(t, n, r, i) {
                        function o(t, e) {
                            ...
                            return n || r ? ("leave" == e && (r = n, n = null), x.push({event: e, fn: n}), y.push({event: e, fn: r}), !0) : void 0
                        }
                        function a(e, n, o) {
                            function a(t) {
                                if (n) {
                        ...
                        if (s) {
                            ...
                            if (F(v)) {
                                ...
                                }), {node: s, event: n, className: r, isClassBased: p, isSetClassOperation: h, applyStyles: function () {
                    ...
                    function P(t, n, r, i, o, a, s, u) {
                        ...
                        if (C = C && C.events, i || (i = o ? o.parent() : r.parent()), q(r, i))
                            return v(), d(), p(), g(), w;
                        ...
                        if (!b.isClassBased || b.isSetClassOperation || "animate" == t || T || (T = "addClass" == t == r.hasClass(n)), T)
                            return v(), d(), p(), $(), w;
                        ...
                        var P = I++;
                        return k++, E[n] = b, r.data(m, {last: b, active: E, index: P, totalActive: k}), d(), b.before(function (e) {
                            var i = r.data(m);
                    ...
                    function V(t, e) {
                        if (u(t, b))
                            w.disabled || (w.running = !1, w.structural = !1);
                        else if (e) {
                    ...
                    return{animate: function (t, e, n, r, i) {
                            ...
                            if (n = e.element(n), n = s(n), A(n))
                                return t.$$setClassImmediately(n, r, i, a);
                            var c, l = n.data(u), h = !!l;
                            return l || (l = {}, l.classes = {}), c = l.classes, r = d(r) ? r : r.split(" "), f(r, function (t) {
                                t && t.length && (c[t] = !0)
                            }), i = d(i) ? i : i.split(" "), f(i, function (t) {
                                t && t.length && (c[t] = !1)
                            }), h ? (a && l.options && (l.options = e.extend(l.options || {}, a)), l.promise) : (n.data(u, l = {classes: c, options: a}), l.promise = T(function (e) {
                                var r = n.parent(), i = o(n), a = i.parentNode;
                                if (!a || a.$$NG_REMOVED || i.$$NG_REMOVED)
                                    return void e();
                                var s = n.data(u);
                                n.removeData(u);
                    ...
                    function g(t, e) {
                        ...
                        if (!n) {
                            ...
                            }), n = {total: 0, transitionDelay: o, transitionDuration: i, animationDelay: s, animationDuration: a}, e && (G[e] = n)
                        }
                        return n
                    }
                    function y(t) {
                    ...
                    function b(t, e, n, r) {
                        ...
                        if (i && 0 === v && 0 === m)
                            return c.removeClass(e, n), !1;
                        var y = r || i && v > 0, b = m > 0 && l.animationDelay > 0 && 0 === l.animationDuration, x = p.closeAnimationFns || [];
                        e.data(_, {stagger: l, cacheKey: s, running: p.running || 0, itemIndex: u, blockTransition: y, closeAnimationFns: x});
                        var E = o(e);
                    ...
                    function x(t, e, n, r, i) {
                        ...
                        if (-1 == l.getAttribute("class").indexOf(n) || !h)
                            return void r();
                        var d = "", p = "";
                        ...
                        if (0 === O)
                            return c.removeClass(e, d), T(e, n), void r();
                    ...
                    return{animate: function (t, e, n, r, i, o) {
    ...
    function u(t, e, n, r) {
        ...
        for (var f in u)
            if (u[f].params && (i = a(u[f].params), i.length))
                for (var h in i)
                    s(l, i[h]) >= 0 || (l.push(i[h]), c[i[h]] = t[i[h]]);
        return I({}, c, e)
    }
    function c(t, e, n) {
        if (!n) {
    ...
    function p(t, e) {
        ...
        this.study = function (u) {
            function d(t, n) {
                if (g[n] !== o) {
                    if (m.push(n), g[n] === r)
                        throw m.splice(0, s(m, n)), new Error("Cyclic dependency: " + m.join(" -> "));
                    if (g[n] = r, N(t))
                        v.push(n, [function () {
                                return e.get(t)
                            }], c);
            ...
            return R(u, d), u = m = g = null, function (r, o, a) {
                ...
                for (var x = 0, C = v.length; C > x; x += 3)
    ...
    function $(t, e, n) {
        this.fromConfig = function (t, e, n) {
            ...
            return P(n) && (n = n(r)), null == n ? null : t.get(n, {cache: e, headers: {Accept: "text/html"}}).then(function (t) {
                return t.data
            })
    ...
    function v(t, e, i) {
        ...
        function s(n, i) {
            var o, a, s, u, c;
            return o = n[2] || n[3], c = e.params[o], s = t.substring(h, n.index), a = i ? n[4] : n[4] || ("*" == n[1] ? ".*" : null), u = F.type(a || "string") || r(F.type("string"), {pattern: new RegExp(a)}), {id: o, regexp: a, segment: s, type: u, cfg: c}
        }
        e = I({params: {}}, V(e) ? e : {});
        var u, c = /([:*])([\w\[\]]+)|\{([\w\[\]]+)(?:\:((?:[^{}\\]+|\\.|\{(?:[^{}\\]+|\\.)*\})+))?\}/g, l = /([:]?)([\w\[\]-]+)|\{([\w\[\]-]+)(?:\:((?:[^{}\\]+|\\.|\{(?:[^{}\\]+|\\.)*\})+))?\}/g, f = "^", h = 0, d = this.segments = [], p = i ? i.params : {}, $ = this.params = i ? i.params.$$new() : new F.ParamSet, v = [];
        this.source = t;
        for (var m, g, y; (u = c.exec(t)) && (m = s(u, !1), !(m.segment.indexOf("?") >= 0)); )
            g = o(m.id, m.type, m.cfg, "path"), f += a(m.segment, g.type.pattern.source, g.squash), d.push(m.segment), h = c.lastIndex;
        y = t.substring(h);
        var w = y.indexOf("?");
        if (w >= 0) {
            ...
            if (y = y.substring(0, w), this.sourcePath = t.substring(0, h + w), b.length > 0)
                for (h = 0; u = l.exec(b); )
                    m = s(u, !0), g = o(m.id, m.type, m.cfg, "search"), h = c.lastIndex
        } else
    ...
    function g() {
        ...
        F = this;
        var p, $ = !1, y = !0, w = !1, b = {}, x = !0, C = [], S = {string: {encode: t, decode: i, is: o, pattern: /[^/]*/}, "int": {encode: t, decode: function (t) {
                    return parseInt(t, 10)
                }, is: function (t) {
        ...
        g.$$getDefaultValue = function (t) {
            ...
            I(this, {id: t, type: e, location: i, array: C, squash: E, replace: k, isOptional: S, value: g, dynamic: n, config: r, toString: y})
        }, f.prototype = {$$new: function () {
                return r(this, I(new f, {$$parent: this}))
            }, $$keys: function () {
                for (var t = [], e = [], n = this, r = a(f.prototype); n; )
                    e.push(n), n = n.$$parent;
    ...
    function y(t, r) {
        ...
        function s(r, i, o, a) {
            ...
            return f || d(), {sync: function () {
                    ...
                    var u = n.format(i);
                    if (o = o || {}, a || null === u || (u = "#" + t.hashPrefix() + u), u = s(u, a, o.absolute), !o.absolute || !u)
                        return u;
                    var c = !a && u ? "/" : "", l = r.port();
        ...
        this.rule = function (t) {
            ...
            var n, s = N(e);
            if (N(t) && (t = r.compile(t)), !s && !P(e) && !q(e))
    ...
    function w(t, i) {
        ...
        function m(t) {
            ...
            if ("**" === e[0] && (n = n.slice(s(n, e[1])), n.unshift("**")), "**" === e[e.length - 1] && (n.splice(s(n, e[e.length - 2]) + 1, Number.MAX_VALUE), n.push("**")), e.length != n.length)
                return!1;
            for (var r = 0, i = e.length; i > r; r++)
                "*" === e[r] && (n[r] = "*");
        ...
        function w(t, i, o, s, h, p, $) {
            ...
            return x.locals = {resolve: null, globals: {$stateParams: {}}}, C = {params: {}, current: x.self, $current: x, transition: null}, C.reload = function () {
                ...
                n = n || {}, o = I({location: !0, inherit: !1, relative: null, notify: !0, reload: !1, $retry: !1}, o || {});
                ...
                if (o.inherit && (n = u(p, n || {}, C.$current, v)), !v.params.$$validates(n))
                    return T;
                n = v.params.$$values(n), e = v;
                var A = e.path, O = 0, D = A[O], M = x.locals, P = [];
                if (!o.reload)
                    for (; D && D === d[O] && D.ownParams.$$equals(n, h); )
                        M = P[O] = D.locals, O++, D = A[O];
                if (b(e, c, M, o))
                    return e.self.reloadOnSearch !== !1 && $.update(), C.transition = null, i.when(C.current);
                if (n = l(e.params.$$keys(), n || {}), o.notify && t.$broadcast("$stateChangeStart", e.self, n, c.self, h).defaultPrevented)
                    return $.update(), E;
                for (var N = i.when(M), V = O; V < A.length; V++, D = A[V])
                    M = P[V] = r(M), N = y(D, n, D === e, N, M, o);
                var q = C.transition = N.then(function () {
                    var r, i, a;
                    if (C.transition !== q)
                        return w;
                    for (r = d.length - 1; r >= O; r--)
                        a = d[r], a.self.onExit && s.invoke(a.self.onExit, a.self, a.locals.globals), a.locals = null;
                    for (r = O; r < A.length; r++)
                        i = A[r], i.locals = P[r], i.self.onEnter && s.invoke(i.self.onEnter, i.self, i.locals.globals);
                    return C.transition !== q ? w : (C.$current = e, C.current = e.self, C.params = n, U(C.params, p), C.transition = null, o.location && e.navigable && $.push(e.navigable.url, e.navigable.locals.globals.$stateParams, {$$avoidResync: !0, replace: "replace" === o.location}), o.notify && t.$broadcast("$stateChangeSuccess", e.self, n, c.self, h), $.update(!0), C.current)
                }, function (r) {
        ...
        var x, C, S = {}, E = {}, k = "abstract", A = {parent: function (t) {
                if (j(t.parent) && t.parent)
                    return f(t.parent);
                var e = /^(.+)\.[^.]+$/.exec(t.name);
                return e ? f(e[1]) : x
            }, data: function (t) {
        ...
        x = $({name: "", url: "^", views: null, "abstract": !0}), x.navigable = null, this.decorator = g, this.state = y, this.$get = w, w.$inject = ["$rootScope", "$q", "$view", "$injector", "$resolve", "$stateParams", "$urlRouter", "$location", "$urlMatcherFactory"]
    }
    function b() {
        function t(t, e) {
    ...
    function C(t, n, r, i) {
        ...
        var s = o(), u = s("$animator"), c = s("$animate"), l = {restrict: "ECA", terminal: !0, priority: 400, transclude: "element", compile: function (n, o, s) {
    ...
    function T(t, n) {
        ...
        return{restrict: "A", require: ["?^uiSrefActive", "?^uiSrefActiveEq"], link: function (i, o, a, s) {
                var u = k(a.uiSref, t.current.name), c = null, l = A(o) || t.$current, f = null, h = "A" === o.prop("tagName"), d = "FORM" === o[0].nodeName, p = d ? "action" : "href", $ = !0, v = {relative: l, inherit: !0}, m = i.$eval(a.uiSrefOpts) || {};
    ...
    v.prototype.concat = function (t, e) {
        ...
        for (; u > i; i++)
            a = s[i], l[a] = this.params[a].value(e[a]);
        return l
        ...
        for (o = 0; u > o; o++) {
            ...
            if (l) {
                var g = n[o + 1];
                if (v === !1)
                    null != m && (c += q(m) ? d(m, e).join("-") : encodeURIComponent(m)), c += g;
                else if (v === !0) {
                    var y = c.match(/\/$/) ? /\/?(.*)/ : /(.*)/;
                    c += g.match(y)[1]
                } else
